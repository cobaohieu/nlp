...
class App:
    ...
    def __init__(self,query):
        ...
        self.sentence_frame = LabelFrame(root, text="Truy vấn được tạo", padx=7, pady=7)#5,5
        ...
        self.reset_button = Button(root, text="Quay lại", fg="red", command=root.destroy)
        self.reset_button.pack(side="right", fill="both", expand="yes", padx=10, pady=2)
        self.go_button = Button(root, text="Thực thi", fg="green",command=self.lanch_parsing)
    ...
    def find_sql_file(self):
        ...
        #print(filename)
        self.database_path_label["text"] = "/home/oem/Dev/NLP2SQL-master/database_store/school.sql"
    ...
    def find_csv_file(self):
        ...
        # self.language_path_label["text"] = "/home/oem/Dev/NLP2SQL-master/lang_store/english.csv"
