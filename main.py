...
def main():
    ...
    arg_parser.add_argument('-d', '--database', help='Path to SQL dump file', default="~\doanhnghiep.sql")
    # arg_parser.add_argument('-l', '--language', help='Path to language configuration file', default="~\english.csv")
    arg_parser.add_argument('-l', '--language', help='Path to language configuration file', default="~\vietnamese.csv")
    ...
    arg_parser.add_argument('-s', '--stopwords', help='path to stopwords file', default="~\vietnamese.txt")
